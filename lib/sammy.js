...
(function($) {
  ...
  Sammy.Application = Sammy.Object.extend({
    ...
    // When set to true, this application will look at its location proxy for location changes
    use_location_proxy: false,
    location_proxy: null,
    ...
    run: function(start_url) {
      ...
      // clone window.location if we are using proxy
      this.location_proxy = (this.use_location_proxy ? this.clone(window.location) : null);
    ...
    currentLocation: function() {
      var location = this.clone((this.use_location_proxy ? this.location_proxy : window.location));
      return location;
    },

    // Set a location proxy
    setLocation: function(hash) {
      this.location_proxy.hash = hash;
    },
